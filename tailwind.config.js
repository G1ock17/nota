 ...
 * ACCORD: `surface` = rgb(--color-surface-1-rgb) плотная плитка; стекло — CSS `var(--color-surface)` + .product-card.
...
module.exports = {
  ...
  theme: {
    extend: {
      fontFamily: {
        sans: ["Accord Numerals", "Constantine", "Cormorant Garamond", "Times New Roman", "serif"],
        serif: ["Accord Numerals", "Constantine", "Cormorant Garamond", "Times New Roman", "serif"],
      },
      colors: {
